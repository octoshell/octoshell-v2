...
Face::MyMenu.items_for(:user_submenu) do
  add_item(t('user_submenu.projects'), core.projects_path, /^core/)
end


Face::MyMenu.items_for(:admin_submenu) do
  add_item(t('admin_submenu.projects'),
  ...
  sureties_title = if sureties_count.zero?
   ...
   add_item_if_may(sureties_title,
   ...
   requests_title = if requests_count.zero?
    ...
    add_item_if_may(requests_title,
             core.admin_requests_path,
             'core/admin/requests')


      add_item_if_may(t("admin_submenu.organizations"), core.admin_organizations_path, 'core/admin/organizations')

      add_item_if_may(t("admin_submenu.clusters"), core.admin_clusters_path, 'core/admin/clusters')

      add_item_if_may(t("admin_submenu.cluster_logs"), core.admin_cluster_logs_path, 'core/admin/cluster_logs')

      add_item_if_may(t("admin_submenu.quota_kinds"), core.admin_quota_kinds_path, 'core/admin/quota_kinds')

      add_item_if_may(t("admin_submenu.project_kinds"), core.admin_project_kinds_path, 'core/admin/project_kinds')
      #projects
      add_item_if_may(t("admin_submenu.organization_kinds"), core.admin_organization_kinds_path, 'core/admin/organization_kinds')
      #organization

      add_item_if_may(t("admin_submenu.direction_of_sciences"), core.admin_direction_of_sciences_path, 'core/admin/direction_of_sciences')

      add_item_if_may(t("admin_submenu.critical_technologies"), core.admin_critical_technologies_path, 'core/admin/critical_technologies')

      add_item_if_may(t("admin_submenu.research_areas"), core.admin_research_areas_path, 'core/admin/research_areas')

      if User.superadmins.include? current_user
        add_item(t("admin_submenu.countries"), core.admin_countries_path, 'core/admin/countries')
        add_item(t("admin_submenu.cities"), core.admin_cities_path, 'core/admin/cities')
      end
end
