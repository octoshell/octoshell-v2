...
- category:       0=широковещательное, >0=уведомление для одного пользователя, другое=по умолчанию не показывать
...
- active:         nil/int. 1 = показывать, другое = нет
- hidden:         bool. false = показывать, true = пользователь скрыл сообщение
