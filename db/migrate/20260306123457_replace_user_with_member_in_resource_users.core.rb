# This migration comes from core (originally 20260306121700)
class ReplaceUserWithMemberInResourceUsers < ActiveRecord::Migration[5.2]
  def up
    ...
    if foreign_key_exists?(:core_resource_users, column: :user_id)
      remove_foreign_key :core_resource_users, column: :user_id
    end
  ...
  def down
    ...
    add_foreign_key :core_resource_users, :users, column: :user_id
