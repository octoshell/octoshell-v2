...
ActiveRecord::Schema.define(version: 2019_07_09_134506) do
  ...
  create_table "wikiplus_pages", force: :cascade do |t|
    t.string   "name_ru"
    t.text     "content_ru"
    t.string   "url"
  ...
  add_index "wikiplus_pages", ["mainpage_id"], name: "index_wikiplus_pages_on_mainpage_id", using: :btree
  add_index "wikiplus_pages", ["url"], name: "index_wikiplus_pages_on_url", unique: true, using: :btree
