...
ActiveRecord::Schema[8.0].define(version: 20_260_315_224_742) do
  ...
  create_table 'cloud_computing_accesses', force: :cascade do |t|
    ...
    t.index %w[for_type for_id], name: 'index_cloud_computing_accesses_on_for_type_and_for_id'
  ...
  create_table 'cloud_computing_conditions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[from_type from_id], name: 'index_cloud_computing_conditions_on_from_type_and_from_id'
    t.index %w[to_type to_id], name: 'index_cloud_computing_conditions_on_to_type_and_to_id'
  end
  ...
  create_table 'cloud_computing_items', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[holder_type holder_id], name: 'index_cloud_computing_items_on_holder_type_and_holder_id'
  ...
  create_table 'cloud_computing_requests', force: :cascade do |t|
    ...
    t.index %w[for_type for_id], name: 'index_cloud_computing_requests_on_for_type_and_for_id'
  end
  ...
  create_table 'comments_comments', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[attachable_type attachable_id], name: 'index_comments_comments_on_attachable_type_and_attachable_id'
  ...
  create_table 'comments_file_attachments', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[attachable_id attachable_type], name: 'attach_index'
  ...
  create_table 'comments_taggings', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[attachable_type attachable_id], name: 'index_comments_taggings_on_attachable_type_and_attachable_id'
    t.index ['context_id'], name: 'index_comments_taggings_on_context_id'
    t.index %w[tag_id attachable_id attachable_type context_id], name: 'att_contex_index', unique: true
  ...
  create_table 'core_accesses', id: :serial, force: :cascade do |t|
    ...
    t.index %w[project_id cluster_id], name: 'index_core_accesses_on_project_id_and_cluster_id', unique: true
  ...
  create_table 'core_job_notification_project_settings', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[core_job_notification_id core_project_id user_id],
            name: 'idx_core_job_proj_settings_notif_proj_user_uniq', unique: true
  ...
  create_table 'core_job_notification_user_defaults', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[core_job_notification_id user_id], name: 'idx_core_job_user_defaults_notif_user_uniq', unique: true
  ...
  create_table 'core_members', id: :serial, force: :cascade do |t|
    ...
    t.index %w[owner user_id project_id], name: 'index_core_members_on_owner_and_user_id_and_project_id'
    ...
    t.index %w[user_id owner], name: 'index_core_members_on_user_id_and_owner'
    t.index %w[user_id project_id], name: 'index_core_members_on_user_id_and_project_id', unique: true
  ...
  create_table 'core_node_partitions', force: :cascade do |t|
    ...
    t.index %w[node_id partition_id], name: 'index_core_node_partitions_on_node_id_and_partition_id', unique: true
  ...
  create_table 'core_nodes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[cluster_id name], name: 'index_core_nodes_on_cluster_id_and_name', unique: true
  ...
  create_table 'core_notices', id: :serial, force: :cascade do |t|
    ...
    t.index %w[linkable_type linkable_id], name: 'index_core_notices_on_linkable_type_and_linkable_id'
    t.index %w[sourceable_type sourceable_id], name: 'index_core_notices_on_sourceable_type_and_sourceable_id'
  end
  ...
  create_table 'core_resource_control_partitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['partition_id'], name: 'index_core_resource_control_partitions_on_partition_id'
    t.index ['resource_control_id'], name: 'index_core_resource_control_partitions_on_resource_control_id'
  end
  ...
  create_table 'core_resource_users', force: :cascade do |t|
    ...
    t.index %w[member_id access_id], name: 'index_core_resource_users_on_member_id_and_access_id', unique: true,
  ...
  create_table 'face_users_menus', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[user_id menu], name: 'index_face_users_menus_on_user_id_and_menu', unique: true
  ...
  create_table 'jobstat_jobs', id: :serial, force: :cascade do |t|
    ...
    t.unique_constraint %w[cluster drms_job_id drms_task_id], name: 'uniq_jobs'
  end
  ...
  create_table 'pack_accesses', id: :serial, force: :cascade do |t|
    ...
    t.string 'to_type'
    t.bigint 'to_id'
    t.index %w[to_type to_id], name: 'index_pack_accesses_on_to_type_and_to_id'
    t.index ['version_id'], name: 'index_pack_accesses_on_version_id'
    t.index %w[who_type who_id], name: 'index_pack_accesses_on_who_type_and_who_id'
  end
  ...
  create_table 'sessions_projects_in_sessions', id: :serial, force: :cascade do |t|
    ...
    t.index %w[session_id project_id], name: 'i_on_project_and_sessions_ids', unique: true
  ...
  create_table 'sessions_stats', id: :serial, force: :cascade do |t|
    ...
    t.integer 'organization_id'
    t.text 'cache'
    t.index %w[session_id organization_id], name: 'index_sessions_stats_on_session_id_and_organization_id'
    t.index %w[session_id survey_field_id], name: 'index_sessions_stats_on_session_id_and_survey_field_id'
  ...
  create_table 'sessions_survey_values', id: :serial, force: :cascade do |t|
    ...
    t.index %w[survey_field_id user_survey_id], name: 'isurvey_field_and_user'
  ...
  create_table 'sessions_user_surveys', id: :serial, force: :cascade do |t|
    ...
    t.index %w[session_id survey_id], name: 'index_sessions_user_surveys_on_session_id_and_survey_id'
  ...
  create_table 'support_tickets_subscribers', id: :serial, force: :cascade do |t|
    t.integer 'ticket_id'
    t.integer 'user_id'
    t.index %w[ticket_id user_id], name: 'index_support_tickets_subscribers_on_ticket_id_and_user_id', unique: true
