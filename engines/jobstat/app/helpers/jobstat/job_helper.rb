module Jobstat
  module JobHelper
    ...
    def get_select_options_by_projects projects, selected=[]
      ...
      [["-- RNF --","vadim", "shvets", "-- Worlid domination --", "vurdizm", "wasabiko", "ivanov", "-- Postgraduate play --", "afanasievily_251892", "gumerov_219059"], selected: sele    cted, disabled: ["-- RNF --","-- Worlid domination --","-- Postgraduate play --"]]
