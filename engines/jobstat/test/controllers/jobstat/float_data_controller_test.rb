  ...
  class FloatDataControllerTest < ActionController::TestCase
    ...
    test "should create float_datum" do
      assert_difference('FloatDatum.count') do
        post :create, float_datum: { name: @float_datum.name, task_id: @float_datum.task_id, value: @float_datum.value }
      end
    ...
    test "should update float_datum" do
      patch :update, id: @float_datum, float_datum: { name: @float_datum.name, task_id: @float_datum.task_id, value: @float_datum.value }
      assert_redirected_to float_datum_path(assigns(:float_datum))
    end
