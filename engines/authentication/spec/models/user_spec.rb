...
RSpec.describe User, type: :model do
  ...
  describe 'mail sending' do
    ...
    it 'sends activation success mail' do
      user.activate!
      expect(ActionMailer::Base.deliveries.last).to have_attributes(to: ['basya@bulat.com'],
    ...
    it 'deletes only old pending users' do
      # Authentication.delete_after = 6.months
      user = create(:unactivated_user, created_at: Date.today - 1.day, activation_state: :pending)
